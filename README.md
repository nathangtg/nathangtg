...
- **Frontend:** React, Vue, HTML, CSS, JavaScript, Tailwind, jQuery
- **Backend:** Laravel, NextJS, NodeJS, PHP
- **Programming Languages:** Python, JavaScript, PHP, TypeScript, Java, C++

## Current Projects

I'm currently working on:

- **Jangular-CLI**: A tool that has reached over 6,000 downloads on NPM in its first week [Open to contribution](https://github.com/nathangtg/jangular-cli)
- **DynamoSQL**: An upcoming project aimed to bridge SQL developers and DynamoDB's learning curve, designed to function as a Prisma-like ORM

## Interests

- Looking for collaboration opportunities in Web Development
- Music enthusiast who enjoys arranging, playing, and performing at gigs
